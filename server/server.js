...
app.get('/', function (request, response) {
    response.sendFile(path.join(__dirname + '/Users/mathildekoch/Desktop/Programmeringseksamensopgave/view/register.html'));
});

//Login Route
app.get('/login', function (request, response) {
    response.sendFile(path.join(__dirname + '/Users/mathildekoch/Desktop/Programmeringseksamensopgave/view/login.html'));
});
